...
import { usePremiumActions } from '../hooks/actions/usePremiumActions'; // Import premium actions
...
const CityView = ({
    ...
    const { onRecruitAgent, onAssignAgent, onSendLiberator } = useAgentActions(cityGameState, saveGameState, setMessage);
