...
const GodTownModal = ({ townId, onClose, onAttack }) => {
    ...
    useEffect(() => {
        ...
        //  Use onSnapshot for real-time updates for town data
        ...
        //  Use onSnapshot for real-time updates for player progress
    ...
    //  Determine loading state based on whether data has arrived.
    useEffect(() => {
