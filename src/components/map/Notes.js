...
const Notes = ({ onClose }) => {
    ...
    //  Fetch notes from the subcollection
    useEffect(() => {
    ...
    //  Debounced save function for the text editor
    ...
    //  Share note by creating a public document and copying BBCode
    ...
    //  Handlers for making the notes panel draggable
