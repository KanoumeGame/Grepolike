...
//  A component to display unit stats in a clean, consistent way
...
const BarracksMenu = ({ resources, availablePopulation, onTrain, onFire, onClose, cityGameState, unitQueue, onCancelTrain, onSpeedUp }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70" onClick={onClose}>
            ...
            >
                ...
                <UnitQueue unitQueue={barracksUnitQueue} onCancel={(item) => onCancelTrain(item, 'barracks')} title="Land Unit Queue" onSpeedUp={onSpeedUp} />
            </div>
        </div>
    );
};
