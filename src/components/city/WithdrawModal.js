...
const WithdrawModal = ({ city, onClose, onWithdrawTroops }) => {
    ...
    //  handle changes in the withdrawal amount input fields
    ...
    //  initiate the withdrawal process for the selected troops
    ...
    //  Filter reinforcements to only show those owned by the current user
