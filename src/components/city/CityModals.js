    ...
    <>
      ...
      {isSenateViewOpen && (
        <SenateView
          ...
          onSpeedUp={premiumActions.speedUpBuilding}
      ...
      {isBarracksMenuOpen && (
        <BarracksMenu
          ...
          onSpeedUp={(item) => premiumActions.speedUpTraining(item, 'barracks', cityGameState, saveGameState)}
        />
      )}
       {isDivineTempleMenuOpen && (
        <DivineTempleMenu
          ...
          cityGameState={cityGameState}
          onSpeedUp={(item) => premiumActions.speedUpTraining(item, 'divineTemple', cityGameState, saveGameState)}
        />
      )}
      {isShipyardMenuOpen && (
        <ShipyardMenu
          ...
          onSpeedUp={(item) => premiumActions.speedUpTraining(item, 'shipyard', cityGameState, saveGameState)}
        />
      )}
      {isTempleMenuOpen && (
        <TempleMenu
      ...
      {isHeroesAltarOpen && (
        <HeroesAltar
            ...
            movements={movements}
            onHealHero={(heroId) => premiumActions.healHero(heroId, cityGameState, saveGameState)}
        />
      )}
      {isPrisonMenuOpen && (
        <PrisonMenu
