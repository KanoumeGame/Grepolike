...
const HeroesAltar = ({ cityGameState, onRecruitHero, onActivateSkill, onClose, onAssignHero, onUnassignHero, onLevelUpHero, onAddHeroXp, onRecruitAgent, onAssignAgent, movements, onHealHero }) => {
                        ...
                        <div className="hero-text">
                            ...
                            {isWounded && (
                                <div className="text-center mt-2 text-red-600 font-bold">
                                    ...
                                    <button onClick={() => onHealHero(selectedHeroId)} className="btn btn-primary text-xs mt-1">
                                        Heal (100 <PlatinumIcon className="inline-block w-4 h-4" />)
                                    </button>
                                </div>
                            )}
                            {isHeroCaptured && (
