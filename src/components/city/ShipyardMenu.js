...
const ShipyardMenu = ({ resources, availablePopulation, onTrain, onClose, cityGameState, unitQueue, onCancelTrain, onSpeedUp }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70" onClick={onClose}>
            ...
            >
                ...
                <UnitQueue unitQueue={navalUnitQueue} onCancel={(item) => onCancelTrain(item, 'shipyard')} title="Naval Unit Queue" onSpeedUp={onSpeedUp} />
            </div>
        </div>
    );
};
