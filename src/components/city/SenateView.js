...
const SenateView = ({ buildings, resources, onUpgrade, onDemolish, getUpgradeCost, onClose, usedPopulation, maxPopulation, buildQueue = [], onCancelBuild, onCompleteInstantly, setMessage, cityGameState, onOpenSpecialBuildingMenu, onDemolishSpecialBuilding, currentUser, worldId, onAddWorker, onRemoveWorker, getMaxWorkerSlots, availablePopulation, onApplyWorkerPreset, onSpeedUp, saveGameState }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-30">
            ...
            >
                ...
                <BuildQueue buildQueue={buildQueue} onCancel={onCancelBuild} onCompleteInstantly={onCompleteInstantly} onSpeedUp={(item) => onSpeedUp(item, cityGameState, saveGameState)} />
