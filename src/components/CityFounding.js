...
const CityFounding = ({ onCityFounded }) => {
    ...
    //  Add state for religion and nation selection
    ...
    const handleFoundCity = async (e) => {
        ...
        try {
            ...
            //  Check for existing city names to avoid duplicates
            ...
            //  Set the top-level game document with initial data, including battle points
