...
//  The main component for editing all game data
const GameDataEditor = ({ dataType }) => {
    ...
    const [data, setData] = useState(() => {
        //  Pre-process troop data to ensure heal_cost and heal_time exist for all units
    ...
    const renderEditor = () => {
        ...
        switch (dataType) {
            case 'troops':
                //  Get the base unit type by splitting the ID string.
