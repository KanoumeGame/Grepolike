...
// Pre-load all necessary images for reports
const images = {};
const imageContexts = [
...
const ReportsView = ({ onClose, onActionClick }) => {
    ...
    //  Handle selecting a report and marking it as read
    ...
    //  Determine the color of the report title based on its type and outcome
    ...
    //  Get the display title for a report
    ...
    //  Render a list of units, optionally styled as losses
    ...
    //  Safely get an image URL from the pre-loaded images map
    ...
    //  Render a grid of troop icons with counts
    ...
    //  Render hero display in a report
    ...
    //  Render resource icons with amounts
    ...
    //  Render building icons with levels
    ...
    //  Main function to render the detailed content of a selected report
