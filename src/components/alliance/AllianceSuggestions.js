...
//  Cache for player points to reduce reads. Alliance data will be real-time.
...
const AllianceSuggestions = ({ onAllianceClick, onOpenCreate }) => {
    ...
    useEffect(() => {
        ...
        //  Set up a real-time listener for alliance changes (members, status, etc.)
        const unsubscribe = onSnapshot(q, async (snapshot) => {
            ...
            //  Fetch or use cached player points
            ...
            //  Combine real-time alliance data with cached points
