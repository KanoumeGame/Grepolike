...
//  This hook provides actions related to building management in a city.
export const useBuildingActions = ({
    ...
    //  Handles the logic for upgrading or constructing a building.
    const handleUpgrade = async (buildingId) => {
        ...
        //  Check all building and research requirements, including those in the queue.
        ...
        if (requirements) {
            ...
            if (unmetRequirements.length > 0) {
                //  Join with newline characters for multi-line display in the modal.
    ...
    //  Instantly completes the first building in the queue.
