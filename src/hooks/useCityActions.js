...
export const useCityActions = (props) => {
    ...
    //  Handles clicks on building plots in the city view.
    const handlePlotClick = (buildingId) => {
        ...
        if (!buildingData || buildingData.level === 0) {
            //  If the special building plot is clicked and it's not built, open the menu
        ...
        switch (buildingId) {
            ...
            case 'prison': openModal('isPrisonMenuOpen'); break; //  Open prison menu
            //  Handle special building plot click
