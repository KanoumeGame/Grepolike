export const parseBBCode = (text) => {
    ...
    //  New BBCode formats for reports
    ...
    // [island x=x y=y]Island Name[/island]
    html = html.replace(/\[island x=([\d.]+) y=([\d.]+)\](.*?)\[\/island\]/gs, '<span class="bbcode-action" data-action-type="go_to_city" data-action-coords-x="$1" data-action-coords-y="$2">$3</span>');
