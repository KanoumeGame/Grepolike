...
export function calculateTravelTime(distance, speed, mode = null, worldState = null, unitTypes = [], windSpeed = 0) {
    //  Special fast calculation for scout and trade modes
    ...
    if (worldState) {
        ...
        if (hasNaval || hasFlying) {
            //  Wind speed modifier for naval units.
        ...
        switch(worldState.weather) {
            case 'Rainy':
                ...
                break;
            case 'Stormy':
                //  Storms have a general large penalty on top of wind effects
